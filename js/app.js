        ...
        <div class="footer-grid">
          <div class="footer-col">
            ...
            <div class="social-links">
              ...
              <a href="https://instagram.com/aurashop_alpha" target="_blank" class="btn-icon" title="Instagram"><i class="fab fa-instagram"></i></a>
              <a href="https://wa.me/+918148750499" target="_blank" class="btn-icon" title="WhatsApp Us"><i class="fab fa-whatsapp"></i></a>
            </div>
          </div>
          <div class="footer-col">
            <h3>Quick Links</h3>
